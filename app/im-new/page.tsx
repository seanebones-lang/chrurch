    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-blue-900 to-blue-700 text-white py-24">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-blue-200 text-xl leading-relaxed max-w-2xl mb-8">{IM_NEW_INTRO}</p>
          <a
            href="#visit-form"
            className="inline-block px-8 py-4 bg-amber-400 text-amber-900 font-bold rounded-full hover:bg-amber-300 transition-colors"
          >
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-extrabold text-gray-900">At a glance</h2>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <h2 className="text-3xl font-extrabold text-gray-900 mb-6">Before you visit</h2>
            <div className="space-y-3">
              {IM_NEW_FAQ.map(item => (
                <details key={item.question} className="bg-gray-50 rounded-xl border border-gray-200 p-4 group">
                  <summary className="font-semibold text-gray-900 cursor-pointer list-none flex justify-between items-center gap-2">
                    <span>{item.question}</span>
                    <span className="text-gray-400 group-open:rotate-180 transition-transform text-xl shrink-0">⌄</span>
                  </summary>
